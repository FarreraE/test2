...
function validateCol(cardAux, random) {
    ...
    if (cardAux.yIndex == 0) {
        /*SI SUPERA LAS VALIDACION VERTICAL LLAMA LA FUNCIÓN
              VALIDATE ROW QUE COMPRUEBA LAS FILAS.
              */
...
// RETORNA UN VALOR RANDOM ENTRE UNO Y CUATRO
function getRandom() {
    //AUMENTA EL CONTADOR DE SOLICITUDES PARA VALIDACAIONES
    randomCount++;
    try {
        //ASIGNA UN DATO ENTRE UNO Y 200
        let random = Math.round(Math.random() * 200 + 1);
        /*EN CASO DE ALCANZAR 100 SOLICITUDES RETORNA UN FALSE 
        LA FUNCIÓN board_manager REINICIA EL TABLERO*/
        if (randomCount == 100) {
            randomCount = 0;
            return false;
        }
        //CONVIERTE EL VALOR RANDOM EN UN RANGO DE 1 A 4
...
//VALIDAR SI YA SE HA ASIGNADO EL VALOR RANDOM EN EL GRID
...
// 3 CREAR EL TABLERO JQUERY EN HTML

// 4 ESTILO DE TABLEROS 